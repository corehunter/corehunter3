...
{
	/**
	 * Gets the allele score of the marker for the given entity. The marker scores
	 * are encoded as 0, 1 or 2. 0 is used for homozygote for one allele and 2 is
	 * used for homozygote for one allele. 1 is used to denote heterozygotes. It
	 * is not important which allele is encoded as 0 or 2, as long as it is
	 * consistent for a specific marker.
	 * 
	 * @param entityId
	 ...
	 * @return the allele score of the marker for the given entity, must be 0, 1
	 *         or 2.
	 */
