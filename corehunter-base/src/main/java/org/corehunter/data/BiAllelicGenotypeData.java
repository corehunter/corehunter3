...
public interface BiAllelicGenotypeData extends FrequencyGenotypeData {
     ...
     * for a specific marker. If the allele score is missing this method returns
     * {@link CoreHunterConstants#MISSING_ALLELE_SCORE}.
     *
     ...
     * @return the allele score of the marker for the given entry (0, 1 or 2);
     *         {@link CoreHunterConstants#MISSING_ALLELE_SCORE} if missing
     */
