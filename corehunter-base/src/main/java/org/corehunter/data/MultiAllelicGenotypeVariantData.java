...
/**
 * Data contains relative frequencies of markers that have two or more alleles. If all the markers used in these data
 * have two and only two alleles, such as SNP data, then it more efficient to use {@link BiAllelicGenotypeVariantData}
 *
...
public interface MultiAllelicGenotypeVariantData extends GenotypeVariantData {
     ...
     *                    number of alleles for a given marker and is returned by {@link #getNumberOfAlleles(int)}
     * @return the relative frequency of an allele for a given marker in a given entity
     */
     ...
     *
     * @param entityIds   the IDs of the entity, must be a subset of the IDs returned by {@link #getIDs()}
     * @param markerIndex the index of the marker within the range 0 to n-1, where n is the total number of markers and
     *                    is returned by {@link #getNumberOfMarkers()}
     * @param alleleIndex the index of the allele for the given marker within the range 0 to m-1, where m is the total
     *                    number of alleles for a given marker and is returned by {@link #getNumberOfAlleles(int)}
