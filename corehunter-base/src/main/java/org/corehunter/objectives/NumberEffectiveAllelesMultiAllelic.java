...
{
	/* (non-Javadoc)
	 * @see org.jamesframework.core.problems.objectives.Objective#evaluate(org.jamesframework.core.problems.solutions.Solution, java.lang.Object)
	 */
  @Override
  	...
  	double score = 0;
		...
		while (iterator.hasNext())
		{
			for (int markerIndex = 0 ; markerIndex < numberOfMarkers ; ++markerIndex)
			{
				...
				{
					Pla = data.getAlelleFrequency(iterator.next(), markerIndex, alleleIndex) ;
