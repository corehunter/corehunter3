 ...
 *
 */
public class CavalliSforzaEdwardsDistanceMultiAllelic extends AbstractGenotypeVariantDistanceMetric<MultiAllelicGenotypeVariantData>
{

	/**
	 * @param data
	 */
  public CavalliSforzaEdwardsDistanceMultiAllelic(MultiAllelicGenotypeVariantData data)
  {
	  super(data);
  }
  ...
  public double getDistance(int idX, int idY)
  {
		...
		distance = 1.0 / (Math.sqrt(2.0 * numberOfMarkers)) * Math.sqrt(sumMarkerSqDiff);
