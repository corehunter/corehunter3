/*******************************************************************************
 * Copyright 2014 Herman De Beukelaer, Guy Davenport
 *
...
public class Corehunter
{
	...
	{
    SubsetProblemWithData<DistanceMatrixData> problem = new SubsetProblemWithData<DistanceMatrixData>(objective, data, subsetSize);

    RandomDescent<SubsetSolution> search = new RandomDescent<SubsetSolution>(problem, new SingleSwapNeighbourhood());
