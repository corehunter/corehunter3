 ...
 * all the markers used in these data have two and only two alleles, such as classic SNP 
 * data, then it more efficient to use {@link BiAllelicGenotypeVariantData}
 * 
...
public interface MultiAllelicGenotypeVariantData extends GenotypeVariantData
{
	 ...
	 * @param alleleIndex the index of the allele for the given marker within the range 0 to m-1, 
	 * where m is the total number of alleles for a given marker and is returned by {@link #getNumberOfAllele(int)}
