...
{
	protected static final double[][] DISTANCES = 
			new double[][] {
	...
	protected static final String[] NAMES = new String[]{"Name1", "Name2", "Name3", "Name4", "Name5"} ;
	...
	protected static final DistanceMatrixData DATA = new SimpleDistanceMatrixData(NAMES, DISTANCES);
